...
const RAW: Omit<TodayPrice, 'id'>[] = [
  { commodity: 'Onion', state: 'Maharashtra', district: 'Mumbai', market: 'Vashi APMC', min_price: 2600, max_price: 2900, modal_price: 2750, arrival_quantity: 1800, price_unit: 'Quintal', commodity_icon: icon('Onion') },
  ...
  { commodity: 'Onion', state: 'Maharashtra', district: 'Mumbai', market: 'Mulund APMC', min_price: 2550, max_price: 2850, modal_price: 2700, arrival_quantity: 650, price_unit: 'Quintal', commodity_icon: icon('Onion') },
  ...
  { commodity: 'Onion', state: 'Maharashtra', district: 'Pune', market: 'Pune APMC', min_price: 2400, max_price: 2700, modal_price: 2550, arrival_quantity: 720, price_unit: 'Quintal', commodity_icon: icon('Onion') },
  ...
  { commodity: 'Onion', state: 'Maharashtra', district: 'Pune', market: 'Manchar APMC', min_price: 2350, max_price: 2650, modal_price: 2500, arrival_quantity: 480, price_unit: 'Quintal', commodity_icon: icon('Onion') },
  ...
  { commodity: 'Onion', state: 'Maharashtra', district: 'Pune', market: 'Junnar APMC', min_price: 2300, max_price: 2600, modal_price: 2450, arrival_quantity: 520, price_unit: 'Quintal', commodity_icon: icon('Onion') },
  ...
  { commodity: 'Onion', state: 'Maharashtra', district: 'Nashik', market: 'Lasalgaon APMC', min_price: 2700, max_price: 3000, modal_price: 2850, arrival_quantity: 1250, price_unit: 'Quintal', commodity_icon: icon('Onion') },
